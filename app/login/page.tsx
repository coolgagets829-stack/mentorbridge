            ...
            <>
              <div style={{marginBottom:'20px'}}>
                ...
                <div style={{display:'flex', gap:'10px'}}>
                  ...
                  <input type="tel" placeholder="10 digit mobile number" value={phone} onChange={e => setPhone(e.target.value)} style={{flex:1, padding:'14px 16px', borderRadius:'12px', border:'1.5px solid #e5e7eb', fontSize:'14px', background:'#f9fafb', outline:'none'}}/>
                </div>
              </div>
              ...
              <button onClick={handleSeekerLogin} disabled={loading} style={{width:'100%', padding:'16px', background:'#f97316', color:'white', borderRadius:'16px', fontWeight:'700', fontSize:'15px', border:'none', cursor:'pointer', boxShadow:'0 4px 12px rgba(249,115,22,0.3)'}}>
          ...
          {role === "consultant" && (
            <>
              <div style={{marginBottom:'20px'}}>
                ...
                <input type="email" placeholder="yourname@gmail.com" value={email} onChange={e => setEmail(e.target.value)} style={{width:'100%', padding:'14px 16px', borderRadius:'12px', border:'1.5px solid #e5e7eb', fontSize:'14px', background:'#f9fafb', outline:'none', boxSizing:'border-box'}}/>
              </div>

              <div style={{marginBottom:'8px'}}>
                <label style={{fontSize:'12px', fontWeight:'600', color:'#374151', display:'block', marginBottom:'8px'}}>Password</label>
                <input type="password" placeholder="Enter your password" value={password} onChange={e => setPassword(e.target.value)} style={{width:'100%', padding:'14px 16px', borderRadius:'12px', border:'1.5px solid #e5e7eb', fontSize:'14px', background:'#f9fafb', outline:'none', boxSizing:'border-box'}}/>
              </div>
              ...
              <button onClick={handleConsultantLogin} disabled={loading} style={{width:'100%', padding:'16px', background: loading ? '#fed7aa' : '#f97316', color:'white', borderRadius:'16px', fontWeight:'700', fontSize:'15px', border:'none', cursor: loading ? 'not-allowed' : 'pointer', boxShadow:'0 4px 12px rgba(249,115,22,0.3)'}}>
